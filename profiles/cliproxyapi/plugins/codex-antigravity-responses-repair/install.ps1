...
if ((Split-Path -Leaf $artifactPath) -notmatch '^codex-antigravity-responses-repair-linux-amd64-v.+\.so$') {
  throw "Artifact must be a versioned codex-antigravity-responses-repair Linux amd64 .so file."
}
