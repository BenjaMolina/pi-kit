...
- R4 evidence closeout is being prepared as a documentation-only PR from `docs/complete-release-v0.11.0` against `main`. Do not move or recreate the release tag. Next: commit, push and merge the evidence PR; this does not alter the published artifact.
