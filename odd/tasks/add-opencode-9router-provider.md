...
- Delivery: both behaviors form one cohesive work-unit commit with tests/docs; commit and PR not yet created. Next: capture work-unit commit and report handoff; package release and user installation belong to separate authorization.
