...
export const MANAGED_PLUGINS: Record<string, PluginManifest> = {
  ...
  "codex-antigravity-responses-repair": {
    ...
    version: "1.0.1",
    description: "Repairs Codex GPT-5 identity for Antigravity Responses requests",
    binaryName: "codex-antigravity-responses-repair.so",
    releaseArtifact: "codex-antigravity-responses-repair-linux-amd64-v1.0.1.so",
    releaseTag: "v0.5.9",
    sha256: "85686e7bc6ee21b3ea3a0ea67343f79c97958753b10b48b70db4baac1a260e00",
